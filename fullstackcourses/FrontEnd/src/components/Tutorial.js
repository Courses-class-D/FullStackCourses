  ...
  render() {
    return (
      <div className="container bg-info border border-danger  p-5 mt-2">
              ...
              {/* <span>programming language : {tutorials.Tag}</span> <t /> */}

              <div className="row">
                <span className="col">Type of Tutorial : {this.props.tutorial.TypeOfTutorial}</span><t />
                <span className="col">Type of Pay  : {this.props.tutorial.TyoeOfPay}</span><t />
                <span className="col">Skill Level : {this.props.tutorial.SkillLevel}</span><t />
              </div>
              <label className="badge badge-pill badge-warning">{this.props.tutorial.Tag}</label>
